            ...
            <div className="col-md-8 col-lg-4 mx-auto">
                <div className="card my-5" style={{ backgroundColor: 'rgb(236, 239, 241)' }}>
                    <article className="card-body mx-auto" style={{ maxWidth: '400px' }}>
                        ...
                        <p>
                            <button className="btn btn-block btn-light  w-100"> <i className="fab fa-google"></i>   Continue With Google</button>
                            <button className="mt-2 btn btn-block btn-twitter w-100 text-white"> <i className="fab fa-twitter"></i>   Continue With Twitter</button>
                            <button className="btn btn-block btn-facebook w-100 mt-2 text-white"> <i className="fab fa-facebook-f"></i>   Continue With Facebook</button>
                        </p>
                        ...
                        <form>
                            ...
                            <p className="text-center">Have an account? <a href="" style={{ color: '#42ba96' }}>Log In</a> </p>
                        </form>
                    </article>
                </div>
            </div>
